<template>
  <div :class="bem()" class="flex px-2 py-1.5 items-center">
    ...
    <BasicTitle @click="handleTitleClick" :helpMessage="helpMessage" v-if="!slots.headerTitle && title" :style="{color:titlecolor}">
      {{ title }}
    </BasicTitle>
    <div
...
<script lang="ts" setup>
  ...
  const emit = defineEmits(['strictly-change', 'search','titleclick']);
