  ...
  >
    ...
    >
      ...
      <!--    width: 33 - datas.imgMargin / 10 + '%', -->
        <img draggable="false" :src="datas.imageList[index - 1].src" alt="" @error="setDefaultImage"/>
      </div>
    </section>
...
<script>
import defaultImage from '/@/assets/webeditor/imgs.png'
export default {
  name: 'magiccube',
  props: {
    datas: Object,
