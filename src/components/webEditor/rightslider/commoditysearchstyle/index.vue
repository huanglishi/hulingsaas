...
import { ElColorPicker,ElConfigProvider,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElTooltip,ElInput} from 'element-plus'
export default {
  ...
  ElColorPicker,ElConfigProvider,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElTooltip,ElInput},
  data() {
    return {
      predefineColors: [
        // 颜色选择器预设
