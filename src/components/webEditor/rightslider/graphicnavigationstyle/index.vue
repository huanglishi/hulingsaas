<template>
  <div class="graphicnavigationstyle">
      ...
      <vuedraggable :list="datas.imageList" item-key="index" :forceFallback="true" :animation="200">
         <template #item="{ element, index}">
          ...
          >
            ...
            <!-- 图片 -->
            <div class="imag" style="position: relative"  @click="showUpload('2',index)">
    ...
    <!-- 上传图片 -->
    <el-button @click="showUpload('0',0)" style="width: 100%;" type="primary" plain
      >点击添加导航</el-button
    >
    <div class="bor"></div>
...
import { ElColorPicker,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElTooltip,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption} from 'element-plus'
...
export default {
  ...
  ElColorPicker,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElTooltip,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption},
  data() {
    return {
      predefineColors: [
        // 颜色选择器预设
