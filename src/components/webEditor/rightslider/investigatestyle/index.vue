...
<script>
import { ElForm,ElFormItem,ElCheckbox,ElButton,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption} from 'element-plus'
export default {
  ...
  components: {
     ElForm,ElFormItem,ElCheckbox,ElButton,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption
  },
  data() {
    return {
