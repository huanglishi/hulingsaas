...
import { ElColorPicker,ElForm,ElFormItem,ElCheckbox,ElButton,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption,ElTooltip,ElSlider} from 'element-plus'
...
export default {
  ...
  ElColorPicker,ElForm,ElFormItem,ElCheckbox,ElButton,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption,ElTooltip,ElSlider },
  data() {
