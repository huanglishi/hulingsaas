<template>
  <div class="magiccubestyle">
    ...
    <section class="buju buju0" v-show="datas.rubiksCubeType === 0">
      ...
      >
        <div style="font-size: 12px;height: 150px;display: inline-flex; justify-content: center; align-items: center;" v-if="!datas.imageList[index - 1].src">
           <div>宽度375像素</div>
        </div>
        <img
          draggable="false"
    ...
    <p style="color: #606266; font-size: 12px; margin-top: 10px">请添加图片</p>
...
import { ElColorPicker,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElInput,ElSelect,ElOption,ElTooltip} from 'element-plus'
export default {
  name: 'magiccubestyle',
  props: {
    datas: Object,
  ...
  ElColorPicker,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElInput,ElSelect,ElOption,ElTooltip
  },
  data() {
    return {
      rubiksCubeTypes: [
...
.magiccubestyle {
  ...
  .magiccubestyleList {
    ...
    .imag {
      ...
      .imhbtn {
        width: 100%;
        background: rgba(153, 153, 153, 0.685);
        position: absolute;
        left: 0;
        bottom: 0px;
        color: #fff;
