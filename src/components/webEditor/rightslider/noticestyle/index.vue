  ...
  <div class="noticestyle">
    ...
    >
      <el-form-item
        ...
        prop="noticeText"
      >
        <el-input type="textarea" v-model="datas.noticeText" placeholder="请输入公告" />
      </el-form-item>
...
<script>
import { ElColorPicker,ElForm,ElFormItem,ElInput} from 'element-plus'
export default {
  name: 'noticestyle',
  props: {
    datas: Object,
  ...
  components: { 
   ElColorPicker,ElForm,ElFormItem,ElInput
  },
  data() {
    return {
      rules: {
