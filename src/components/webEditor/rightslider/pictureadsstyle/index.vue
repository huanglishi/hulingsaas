...
import { ElForm,ElFormItem,ElSlider,ElButton,ElTooltip,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption} from 'element-plus'
export default {
  name: 'pictureadsstyle',
  components: { vuedraggable, uploadimg,
  ElForm,ElFormItem,ElSlider,ElButton,ElTooltip,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption },
  props: {
    datas: Object,
    paglist: Array,
  },
