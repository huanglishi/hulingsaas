<template>
  <div class="storenotecardstyle">
    ...
    <el-form label-width="80px" :model="datas"  :rules="rules">
        ...
        <vuedraggable :list="datas.imageList" item-key="index" :forceFallback="true" :animation="200">
          <template #item="{ element, index }">
            ...
            >
              ...
              <!-- 图片 -->
              <div class="imag"  style="position: relative" @click="$refs.upload.showUpload()">
      ...
      <!-- 上传图片 -->
      <el-button
        @click="()=>{$refs.upload.showUpload();imgActive = 0}"
        class="uploadImg"
        type="primary"
        plain
        >点击添加卡片</el-button
...
import { ElForm,ElFormItem,ElCheckbox,ElButton,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption,ElTooltip,ElSlider} from 'element-plus'
export default {
  ...
  ElForm,ElFormItem,ElCheckbox,ElButton,ElInput,ElRadioGroup,ElRadio,ElSelect,ElOption,ElTooltip,ElSlider
  },
  data() {
  ...
  methods: {
    ...
    uploadInformation(res) {
      if(this.imgActive==0){
          ...
          this.datas.imageList[this.imgActive-1].src = res
        }
    },
