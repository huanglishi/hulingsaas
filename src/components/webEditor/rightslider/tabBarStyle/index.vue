...
import { ElColorPicker,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElInput,ElSelect,ElOption} from 'element-plus'
...
export default {
  ...
  components: {
    uploadimg,
    vuedraggable,
    ElColorPicker,ElForm,ElFormItem,ElSlider,ElCheckbox,ElButton,ElInput,ElSelect,ElOption
  },
  data() {
    return {
      predefineColors: [
