...
import custommodule from '/@/assets/webeditor/custommodule.png'
...
componentProperties.set('videoss', {
  ...
  setStyle: {
    text: '视频',
    src: 'http://tuwen.hulingyun.cn/common/uploadfile/getimage?url=resource/uploads/20220901/1662028096_big_buck_bunny.mp4', // 视频地址
    coverUrl:"http://tuwen.hulingyun.cn/common/uploadfile/getimage?url=resource/uploads/20220901/1662028096_big_buck_bunny.jpg", // 封面地址
    autoplay: false, // 是否自动播放
  },
})
componentProperties.set('music', {
  component: 'music',
  text: '音乐',
  type: '2-2',
  active: true,
  ...
  setStyle: {
    ...
    title:"音乐名称",//音乐名称
    author:"艺术家",//音乐名称
    lrcType:1,//传递歌词方式1=字符串方式,2=HTML 方式,3=文件方式
    loop:'all',//音频循环播放
    lrc:"[00:00.00]没有找到歌词\n[00:04.01]Couldn't find the lyrics.\n[00:08.02]没有找到歌词",//音乐名称
    src: 'http://tuwen.hulingyun.cn/common/uploadfile/getimage?url=resource/staticfile/test.mp3', // 音乐地址
    coverUrl:"http://tuwen.hulingyun.cn/common/uploadfile/getimage?url=resource/staticfile/music.jpg", // 音乐封面
    autoplay: false, // 是否自动播放
    volume:0.5,//音量
    border:0,//边框线
    borderColor:"#E0E0E0",//边框线颜色
