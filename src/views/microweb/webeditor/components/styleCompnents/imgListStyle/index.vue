<template>
  <div class="wrapper">
    ...
    />
    <div class="cotent">
      <div class="img-list-form" v-if="activeName === 'imgList'">
        <div class="form-item">
        ...
        >
          <ul class="flex-list">
            <li
              :class="{
                active: datas.datas.moduleStyle.flexUse === 1,
              }"
              @click="() => (datas.datas.moduleStyle.flexUse = 1)"
              style="background-position: -120px -1351px"
            ></li>
            <li
              style="background-position: -120px -1207px"
              :class="{
                active: datas.datas.moduleStyle.flexUse === 2,
              }"
              @click="() => (datas.datas.moduleStyle.flexUse = 2)"
            ></li>
          </ul>

          <div class="form-item" v-if="datas.datas.moduleStyle.flexUse === 1">
            <div class="title">图文列数：</div>
            <div class="add-image">
              <div
                class="radio"
                :class="{
                  active: datas.datas.moduleStyle.columnNum === 1,
                }"
                @click="() => (datas.datas.moduleStyle.columnNum = 1)"
              >
                <span class="radio-item"></span>
                一列
              </div>
              <div
                class="radio"
                :class="{
                  active: datas.datas.moduleStyle.columnNum === 2,
                }"
                @click="() => (datas.datas.moduleStyle.columnNum = 2)"
              >
                <span class="radio-item"></span>
                两列
              </div>
              <div
                class="radio"
                :class="{
                  active: datas.datas.moduleStyle.columnNum === 3,
                }"
                @click="() => (datas.datas.moduleStyle.columnNum = 3)"
              >
                <span class="radio-item"></span>
                三列
              </div>
          ...
          <div class="form-item" v-if="datas.datas.moduleStyle.flexUse === 2">
            <div class="title">图文位置：</div>
            <div class="add-image">
              <div
                class="radio"
                :class="{
                  active: datas.datas.moduleStyle.imgPosition === 'left',
                }"
                @click="() => (datas.datas.moduleStyle.imgPosition = 'left')"
              >
                <span class="radio-item"></span>
                图片居左
              </div>
              <div
                class="radio"
                :class="{
                  active: datas.datas.moduleStyle.imgPosition === 'right',
                }"
                @click="() => (datas.datas.moduleStyle.imgPosition = 'right')"
              >
                <span class="radio-item"></span>
                图片居右
              </div>
        ...
        >
          <div class="form-item">
            ...
            <div class="add-image">
              <div
                :class="{
                  active: datas.datas.moduleStyle.showImgName,
                }"
                @click="() => (datas.datas.moduleStyle.showImgName = true)"
              >
                <span class="radio-item"></span>
                显示
              </div>
              <div
                ...
                @click="() => (datas.datas.moduleStyle.showImgName = false)"
              >
                <span class="radio-item"></span>
                隐藏
              </div>
          ...
          <div class="form-item">
            ...
            <div class="add-image">
              <div
                class="radio"
                :class="{
                  active: datas.datas.moduleStyle.showImgDetail,
                }"
                @click="() => (datas.datas.moduleStyle.showImgDetail = true)"
              >
                <span class="radio-item"></span>
                显示
              </div>
              <div
                ...
                @click="() => (datas.datas.moduleStyle.showImgDetail = false)"
              >
                <span class="radio-item"></span>
                隐藏
              </div>
